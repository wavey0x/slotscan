...
- Render keyed variable paths with `KeyedVariablePath`; never manually concatenate mapping keys in a table view. Copy eligible keys individually, not the whole path.
